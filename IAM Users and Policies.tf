...
resource "aws_iam_policy" "customPolicy" { //creating policy, 2nd string is callable name
    name = "LLCustomPolicy //this is the output name

    policy = <<EOF //all the policies
{
    "Version": "2012-10-17",
    "Statement": [
        {
...
resource "aws_iam_policy_attachment" "policyBind" {
    name = "attachment"
    users = [aws_iam_user.myUser.name] //attaching the policy to the user
